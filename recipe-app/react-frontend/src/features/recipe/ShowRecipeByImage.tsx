...
import { Button, Card, CardContent, Grid, Typography, FilledInput } from '@mui/material';
import { useNavigate } from 'react-router-dom';
import { AddCategory } from "../category/categorySlice";

const ShowRecipeByImage = () => {
  ...
  return (
    ...
    `}
                ...
                >
                  <CardContent>
                    <Typography variant="h6" component="div" align="center">
                      {r?.image ? (
                        <img src={`data:image/jpeg;base64,${r.image}`} alt={r.name} style={{ width: '18vw', height: '19vh' }} />
                      ) : (
                        <p>{r.name}</p>
                      )}
                    </Typography>
      ...
      <div style={{ position: 'absolute', left: '1.5vw', top: '5vh' }}>
        <Grid container spacing={2} direction="column" alignItems="flex-start" style={{ marginTop: '30px', left: '2vw', top: '0vh', width: '6vw' }}>
          <Grid item>
            <Button
              variant="contained"
              color="primary"
...
export default ShowRecipeByImage;
